...
**Before starting**, if the task is nontrivial or outside your comfort zone: run a [[blindspot-pass]]. If you know a decision is unresolved, use [[grilling]] (interview) or [[prototype]] (divergent options to react to). If you can point to something that already does what you want, use [[reference-anchor]] instead of describing it in prose.
